...
plt.title('Number of top 10 most according to global sales', fontsize=15, fontweight='bold')
plt.xlabel('Publishers')
plt.ylabel("Number of global sales")
plt.show()
´´´
![top_publishers_global_sales](https://github.com/zesch/practical-data-science/blob/main/docs/04%20Visualization%20&%20Analysis/assets/top_publishers_nunique.jpg?raw=true)
